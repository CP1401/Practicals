...
8. Where should global constants be placed in a program?
9. What are two reasons why you should not use global variables?
10. When you have two variables with the same name but in different functions, these said to have different ____?
11. What do you call the red dot in the margin in PyCharm that pauses the program running when using the debugger?  
12. Briefly explain what would be wrong if you had a line of code like `SOME_VALUE += 1` (assume that `SOME_VALUE` is actually a meaningful name).
13. What is the single most important design principle for designing functions?
